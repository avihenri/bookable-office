                                        ...
                                        <tr>
                                            ...
                                            <td class="pull-right">
                                                ...
                                                {!! Form::open(['method' => 'DELETE','route' => ['users.destroy', $user->id],'style'=>'display:inline', 'id' => 'delete-user-'.$user->id]) !!}
                                                    <a href="javascript:void(0)" class="btn btn-danger btn-round btn-sm font-600 font-size-1rem delete-btn" data-toggle="modal" data-target="#delete-modal" data-deleteditem="user" data-itemid="{{ $user->id }}">Delete</a>
                                                {!! Form::close() !!}
                                            </td>
                                        </tr>
                                    @endforeach
